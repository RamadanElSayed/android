...
public abstract class FragmentRequestBinding extends ViewDataBinding {
  ...
  protected FragmentRequestBinding(Object _bindingComponent, View _root, int _localFieldCount,
      MaterialButton buttonAccept, Button buttonDecline, ImageView divider,
      Guideline guidelineStart, AppCompatImageView iconCar, AppCompatImageView iconCost,
      AppCompatImageView iconDestination, AppCompatImageView iconDropoff,
      AppCompatImageView iconPickup, AppCompatImageView iconUser, TextView labelCost,
      TextView labelFrom, TextView labelTo, ConstraintLayout layoutTop, ImageView lineDriverUser,
      ImageView linePickupDropoff, ImageView lineUserDestination, TextView textCost,
      TextView textDriverUserDistance, TextView textFrom, TextView textTo,
  ...
  public static FragmentRequestBinding inflate(@NonNull LayoutInflater inflater,
    ...
    return ViewDataBinding.<FragmentRequestBinding>inflateInternal(inflater, R.layout.fragment_request, root, attachToRoot, component);
  }
  ...
  public static FragmentRequestBinding inflate(@NonNull LayoutInflater inflater,
    ...
    return ViewDataBinding.<FragmentRequestBinding>inflateInternal(inflater, R.layout.fragment_request, null, false, component);
  }
  ...
  public static FragmentRequestBinding bind(@NonNull View view, @Nullable Object component) {
    return (FragmentRequestBinding)bind(component, view, R.layout.fragment_request);
  }
}
