...
public class ItemDocumentBindingImpl extends ItemDocumentBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.media == variableId) {
            setMedia((com.tawabsoft.taxi.common.models.Media) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setMedia(@Nullable com.tawabsoft.taxi.common.models.Media Media) {
        this.mMedia = Media;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        com.tawabsoft.taxi.common.models.Media media = mMedia;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            com.tawabsoft.taxi.common.utils.DataBinder.setMedia(this.image, media);
        }
    }
