...
import com.tawabsoft.taxi.driver.databinding.ActivityStatisticsBinding
import com.tawabsoft.taxi.driver.networking.socket.GetStats
import com.tawabsoft.taxi.driver.networking.socket.QueryType
import com.tawabsoft.taxi.driver.networking.socket.RequestPayment
import com.tawabsoft.taxi.driver.networking.socket.StatisticsResult
...
class StatisticsActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.emptyState.setStateDisplay(EmptyStateRecyclerView.STATE_EMPTY, ImageTextStateDisplay(this, com.tawabsoft.taxi.common.R.drawable.empty_state, getString(R.string.empty_state_driver_earning_title), getString(R.string.empty_state_driver_earning_message)))
