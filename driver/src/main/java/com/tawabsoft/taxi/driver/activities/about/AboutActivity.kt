...
import com.tawabsoft.taxi.driver.BuildConfig
...
class AboutActivity : BaseActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val licenseElement = Element().setTitle(getString(R.string.legal_notices)).setIconDrawable(R.drawable.copyright).setOnClickListener {
            ...
            notices.addNotice(Notice("WilliamChart", "https://github.com/diogobernardino/WilliamChart", "Diogo Bernardino", ApacheSoftwareLicense20()))
        ...
        if (getString(R.string.play_store_driver) != "") aboutPage.addPlayStore(getString(R.string.play_store_driver))
