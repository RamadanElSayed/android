...
public class ItemPromotionBindingImpl extends ItemPromotionBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.item == variableId) {
            setItem((com.tawabsoft.taxi.common.models.Promotion) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItem(@Nullable com.tawabsoft.taxi.common.models.Promotion Item) {
        this.mItem = Item;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        com.tawabsoft.taxi.common.models.Promotion item = mItem;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            com.tawabsoft.taxi.common.utils.DataBinder.setMedia(this.imgThumb, itemMedia);
