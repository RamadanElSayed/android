...
public class ItemCouponBindingImpl extends ItemCouponBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.item == variableId) {
            setItem((com.tawabsoft.taxi.common.models.Coupon) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItem(@Nullable com.tawabsoft.taxi.common.models.Coupon Item) {
        this.mItem = Item;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        com.tawabsoft.taxi.common.models.Coupon item = mItem;
        java.lang.String stringValueOfItemDaysLeft = null;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
                ...
                // read String.valueOf(item.daysLeft)
                stringValueOfItemDaysLeft = java.lang.String.valueOf(itemDaysLeft);
        }
        // batch finished
        if ((dirtyFlags & 0x3L) != 0) {
            // api target 1

            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.textDay, stringValueOfItemDaysLeft);
