...
import com.tawabsoft.taxi.rider.models.ItemMode;
...
public abstract class ItemServiceBinding extends ViewDataBinding {
  ...
  @Bindable
  protected ItemMode mMode;

  protected ItemServiceBinding(Object _bindingComponent, View _root, int _localFieldCount,
      ImageView image, ConstraintLayout rootView, TextView textCost, TextView textTitle) {
  ...
  public abstract void setMode(@Nullable ItemMode mode);
