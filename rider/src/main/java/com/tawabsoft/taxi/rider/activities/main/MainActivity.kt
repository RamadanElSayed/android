...
import com.tawabsoft.taxi.common.activities.chargeAccount.ChargeAccountActivity
import com.tawabsoft.taxi.common.activities.transactions.TransactionsActivity
import com.tawabsoft.taxi.common.activities.travels.TravelsActivity
import com.tawabsoft.taxi.common.interfaces.AlertDialogEvent
import com.tawabsoft.taxi.common.location.MapHelper.centerLatLngsInMap
...
import com.tawabsoft.taxi.common.utils.AlerterHelper.showInfo
import com.tawabsoft.taxi.common.utils.AlerterHelper.showWarning
import com.tawabsoft.taxi.common.utils.CommonUtils
import com.tawabsoft.taxi.common.utils.DataBinder.setMedia
...
import com.tawabsoft.taxi.rider.activities.about.AboutActivity
import com.tawabsoft.taxi.rider.activities.addresses.AddressesActivity
import com.tawabsoft.taxi.rider.activities.coupon.CouponActivity
import com.tawabsoft.taxi.rider.activities.looking.LookingActivity
import com.tawabsoft.taxi.rider.activities.main.adapters.ServiceCategoryViewPagerAdapter
import com.tawabsoft.taxi.rider.activities.main.fragments.ServiceCarousalFragment.OnServicesCarousalFragmentListener
import com.tawabsoft.taxi.rider.activities.profile.ProfileActivity
import com.tawabsoft.taxi.rider.activities.promotions.PromotionsActivity
import com.tawabsoft.taxi.rider.activities.travel.TravelActivity
import com.tawabsoft.taxi.rider.databinding.ActivityMainBinding
import com.tawabsoft.taxi.rider.models.LocationWithName
import com.tawabsoft.taxi.rider.models.OrderedService
import com.tawabsoft.taxi.rider.models.RequestDTO
import com.tawabsoft.taxi.rider.networking.socket.*
...
class MainActivity : RiderBaseActivity(), OnMapReadyCallback, OnServicesCarousalFragmentListener {
        ...
        binding.searchPlace.setOnMenuItemClickListener { item: MenuItem ->
            when (item.itemId) {
                R.id.action_favorites -> {
                    GetAddresses().executeArray<com.tawabsoft.taxi.common.models.Address> {
                        when (it) {
    ...
    private fun findPlace(pretext: String) {
        ...
        val intent = Autocomplete.IntentBuilder(AutocompleteActivityMode.OVERLAY, fields).setInitialQuery(pretext).build(this)
