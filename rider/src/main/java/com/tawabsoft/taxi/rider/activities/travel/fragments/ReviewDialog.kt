...
import com.tawabsoft.taxi.rider.databinding.FragmentReviewBinding
...
class ReviewDialog : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        alertDialogBuilder.setPositiveButton(getString(R.string.alert_ok)) { _: DialogInterface?, which: Int -> mListener!!.onReviewTravelClicked(Review(binding.ratingBar.rating.toInt() * 20, if(binding.reviewText.text != null) binding.reviewText.text.toString() else "", 0)) }
