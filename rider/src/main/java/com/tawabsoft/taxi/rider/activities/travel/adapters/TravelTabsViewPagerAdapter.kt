...
import com.tawabsoft.taxi.rider.activities.travel.fragments.TabDriverInfoFragment
import com.tawabsoft.taxi.rider.activities.travel.fragments.TabReviewFragment
import com.tawabsoft.taxi.rider.activities.travel.fragments.TabStatisticsFragment
import java.util.*

class TravelTabsViewPagerAdapter(manager: FragmentManager, private val context: Context, private val request: Request) : FragmentPagerAdapter(manager) {
